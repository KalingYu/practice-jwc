...
<div class="container-login">
    ...
    <form id="loginbox" class="" action="getresult.php" method="post">
        <div class="row">
            <div class="row">
            ...
            <div class="row">
                <button type="submit" class="offset-l4 offset-s1 center-block waves-effect col s12logingetgrades.php l4 waves-light btn btn-login" id="btn-login" >点击一键评教</button>
            </div>
        </div>
    </form>
